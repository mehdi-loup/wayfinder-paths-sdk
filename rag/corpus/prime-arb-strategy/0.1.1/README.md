...
Pre-positioned cross-chain arbitrage for PRIME between Ethereum (Uniswap V3) and Base (Aerodrome). Executes when the price spread exceeds gas and fee costs.
